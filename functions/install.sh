...
EOF
    ...
    sed -i 's#sandbox_image.*#sandbox_image = "ygqygq2/pause:3.10.1"#' /etc/containerd/config.toml
...
pull-image-on-create: false
EOF
    sed -i 's@#pause_image.*@pause_image = "ygqygq2/pause:3.10.1"@' /etc/crio/crio.conf
